...
const siteTranslations = {
    ...
    ko: {
        name: "KANDENT",
        bio: "제 포트폴리오에 오신 것을 환영합니다!<br>저는 주로 영상 음악과 게임 음악을 작업합니다. <br>편하게 둘러보시고 제 음악을 즐겨주세요! <br>연락을 원하시면 하단의 소셜 미디어 링크를 통해 연락 주세요. <br> <b>현재 커미션은 닫혀 있습니다. </b> <br> SNS 링크는 작동을 하지 않으니, backiirz@gmail.com 으로 연락 주세요.",
        libraryTitle: "음악 보관소",
